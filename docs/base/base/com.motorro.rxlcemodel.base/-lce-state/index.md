...
| [dataIsValid](data-is-valid.md) | [jvm]<br>abstract val [dataIsValid](data-is-valid.md): Boolean<br>A property that is evaluated internally and may mean that data being emitted is stall, invalidated or otherwise 'not-so-valid' until some further emission (say after network reload). |
